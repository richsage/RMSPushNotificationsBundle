...
A bundle to allow sending of push notifications to mobile devices.  Currently supports Android GCM, Blackberry and iOS devices.
...
NOTE: If you are using Windows, you may need to set the Android `use_multi_curl` flag to false for GCM messages to be sent correctly.
